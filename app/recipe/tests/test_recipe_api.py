...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_create_recipe(self):
        """Test create a recipe by the API."""
        payload = {
            'title':'Sample Recipe',
            'time_minutes' : 30,
            'price' : Decimal('10.99'),
    ...
    def test_update_user_returns_error(self):
        """Test chaning user return error."""
        new_user = create_user(email='user2@example.com',password='pass5433')
        recipe = create_recipe(user=self.user)
    ...
    def test_delete_other_users_recipe_error(self):
        """Test trying deleting another user recipe gives error."""
        new_user = create_user(email='user2@example.com',password='pass5433')
    ...
    def test_create_recipe_with_new_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes':10,
            'price':Decimal('2.50'),
            'ingredients':[{'name':'Potato'},{'name':'Tomamto'}]
        }
    ...
    def test_filter_by_tags(self):
        ...
        r1.tags.add(tag1)
        r2.tags.add(tag2)
        r3 = create_recipe(user=self.user, title="Chinese Curry")
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title='Beans Curry')
        r2 = create_recipe(user=self.user, title='Potato chips')
        in1 = Ingredient.objects.create(user=self.user, name='Beans')
        in2 = Ingredient.objects.create(user=self.user, name='Potato')
        r1.ingredients.add(in1)
        r2.ingredients.add(in2)
        r3 = create_recipe(user=self.user, title='Tomato Curry')
